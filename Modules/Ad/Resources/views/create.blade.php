                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="town_id" id="ad_town"
                                                    class="form-control @error('town_id') border-danger @enderror"></select>
                                                @error('town_id')
                                                    <span class="invalid-feedback"
                                                        class="d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="authenticity"
                                                    ...
                                                    <option {{ old('authenticity') == 'original' ? 'selected' : '' }}
                                                        value="original">{{ __('original') }}</option>
                                                    <option {{ old('authenticity') == 'refurbished' ? 'selected' : '' }}
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="condition"
                                                    ...
                                                    <option {{ old('condition') == 'new' ? 'selected' : '' }} value="new">
                                                        {{ __('new') }}</option>
                                                    <option {{ old('condition') == 'used' ? 'selected' : '' }}
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-3">
                                                <div class="icheck-success d-inline">
                                                    <input {{ old('negotiable') == 1 ? 'checked' : '' }} value="1"
                                                        name="negotiable" type="checkbox" class="form-check-input"
                                                        id="checkme" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <input name="thumbnail" type="file" accept="image/png, image/jpg, image/jpeg"
