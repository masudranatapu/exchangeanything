...
Route::prefix('admin')->middleware(['auth:super_admin', 'setlang'])->group(function () {
    ...
    Route::prefix('blog')->group(function () {
        Route::get('/comment', [BlogController::class, 'comment'])->name('blog.comment');
        Route::get('/comment-delete/{id}', [BlogController::class, 'commentDelete'])->name('blog.comment.delete');
        Route::post('/comment-delete', [BlogController::class, 'commentStatus'])->name('blog.comment.status');
        Route::post('/comment-replay', [BlogController::class, 'commentsReplay'])->name('blog.comment.replay');
    });
});
