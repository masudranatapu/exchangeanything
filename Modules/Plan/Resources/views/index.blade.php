            ...
            <div class="col-md-6 col-lg-4 col-xl-3 mb-5">
                <div class="plan-card plan-card--active">
                    <div class="plan-card__top">
                        ...
                        <p class="plan-card__title">@if($plan->package_duration == 1) Lifetime Membership @elseif($plan->package_duration == 2) Annually @elseif($plan->package_duration == 3) Monthly  @endif</p>
                    </div>
