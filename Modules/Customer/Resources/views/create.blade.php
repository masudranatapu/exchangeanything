...
@section('title') {{ __('create_customer') }} @endsection
                        ...
                        <div class="col-md-6 offset-md-3">
                            ...
                            <form class="form-horizontal" action="{{ route('module.customer.store') }}" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <x-forms.input type="text" name="name" value="{{ old('name') }}" placeholder="enter_new_name"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <x-forms.label name="username" required="true" class="col-sm-3 col-form-label"/>
                                    <div class="col-sm-9">
                                        <x-forms.input type="text" name="username" value="{{ old('username') }}" placeholder="username"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <x-forms.input type="password" name="password" value="{{ old('password') }}" placeholder="password"/>
                                    </div>
                                </div>
                                <div class="form-group row">
