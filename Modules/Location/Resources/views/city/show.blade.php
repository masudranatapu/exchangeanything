...
@section('title') '{{ $city->name }}' {{ __('city_wise') }} {{ __('ads') }} @endsection
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="line-height: 36px;">{{ __('city_details') }}</h3>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="line-height: 36px;">'{{ $city->name }}' {{ __('city_wise') }}
                        {{ __('ads') }}</h3>
