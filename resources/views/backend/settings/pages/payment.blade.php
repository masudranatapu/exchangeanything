                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin.paypalsetting') }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="paylive" {{ env('PAYPAL_MODE') == 'live' ? 'checked' : '' }} type="checkbox"
                                    name="paypal_live_mode" button="button1" oldvalue="{{ env('PAYPAL_MODE') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input
                                        ...
                                        value="{{ env('PAYPAL_SANDBOX_CLIENT_ID') }}" name="paypal_client_id" type="text"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input
                                        ...
                                        value="{{ env('PAYPAL_LIVE_CLIENT_ID') }}" name="paypal_client_id" type="text"
                                        class="form-control @error('paypal_client_id') is-invalid @enderror"
                                        autocomplete="off">
                                    @error('paypal_client_id')
                                        <span class="invalid-feedback" role="alert"><span>{{ $message }}</span></span>
                        ...
                        @if (userCan('setting.update'))
                            <div class="form-group row">
                                <x-forms.label name="{{ __('is_active') }}" class="col-sm-3" />
