    ...
    <div class="card">
        <div class="card-header">
            ...
            <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="cookie-tab" data-toggle="pill" href="#cms-cookie" role="tab"
                        aria-controls="cookie" aria-selected="false">{{ __('cookie_policy') }}
                    </a>
                </li>
              <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="membership-tab" data-toggle="pill" href="#cms-membership" role="tab"
                        aria-controls="membership" aria-selected="false">{{ __('membership') }}
                    </a>
                </li>
        ...
        <div class="card-body">
            <div class="tab-content" id="cms-pills-tabContent">
                ...
                <div class="tab-pane fade " id="cms-about" role="tabpanel" aria-labelledby="about-tab">
                    <x-backend.setting.cms.about-setting :aboutheading="$cms->about_heading" :aboutcontent="$cms->about_body" :aboutBackground="$cms->about_background_path" />
                </div>
                ...
                {{-- Cookie --}}
                <div class="tab-pane fade" id="cms-cookie" role="tabpanel" aria-labelledby="cookie-tab">
                    <x-backend.setting.cms.cookie :cms="$cms" />
                </div>
...
@section('script')
    ...
    <script>
        ...
        ClassicEditor
            .create(document.querySelector('#cookie_ck'))
            .catch(error => {
                console.error(error);
            });
