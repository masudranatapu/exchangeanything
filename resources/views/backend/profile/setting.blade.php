                ...
                <div class="col-md-6">
                    <div class="tab-pane active" id="gen_settings">
                        ...
                        <form class="form-horizontal" action="{{ route('profile.update') }}" method="POST"
                            ...
                            <div class="form-group row">
                                <x-forms.label name="change_image" class="col-sm-3" />
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <x-forms.label name="change_password" class="col-sm-3"
                                ...
                                <div class="col-sm-9 mt-2">
                                    ...
                                    <div class="icheck-success d-inline">
                                        ...
                                        <label for="change-password-visibility"></label>
                                    </div>
                                </div>
                            </div>
                            <div id="password_visibility" class="{{ old('isPasswordChange') ? 'd-block' : 'd-none' }}">
                                <div class="form-group row">
                                    <x-forms.label name="current_password" class="col-sm-3" />
                                    <div class="col-sm-9">
