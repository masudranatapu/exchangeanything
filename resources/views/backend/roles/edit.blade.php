                            ...
                            <form role="form" action="{{ route('role.update', $role->id) }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <x-forms.label name="role_name" required="true" for="role_name" />
                                    ...
                                    <div class="form-group">
                                        <x-forms.label name="permission" /> <br>
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <x-forms.label name="all" for="permission_all" class="custom-control-label" />
                                        </div>
                                        <hr>
                                        @php $i=1; @endphp
                                                ...
                                                <div class="col-3">
                                                    <div class="custom-control custom-checkbox">
                                                        <input
                                                            ...
                                                            value="2">
                                                        <x-forms.label name="{{ $group->name }}" for="{{ $i }}management" class="custom-control-label text-capitalize" />
                                                    </div>
                                                </div>
                                                    ...
                                                    @foreach ($permissionss as $permission)
                                                        <div class="custom-control custom-checkbox">
                                                            <input
                                                                ...
                                                                <x-forms.label name="{{ $permission->name }}" for="permission_checkbox_{{ $permission->id }}" class="custom-control-label" />
                                                        </div>
                                                        @php $j++; @endphp
                                                    @endforeach
                                                </div>
