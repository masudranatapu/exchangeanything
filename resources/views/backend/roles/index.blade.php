                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="row d-none" id="allPermission{{ $loop->index + 1 }}">
                                                <a href="#" id="ShowPer{{ $loop->index + 1 }}"
                                                    onclick="HidePermission('allPermission{{ $loop->index + 1 }}' , 'ShowPer{{ $loop->index + 1 }}' )" class="col-md-1">
                                                    <svg width="28px" height="28px" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    @if (userCan('role.delete'))
                                                        <form action="{{ route('role.destroy', $role->id) }}" method="POST"
                                                            ...
                                                            <button
                                                                ...
                                                                class="ml-1 btn bg-danger"><i class="fas fa-trash"></i></button>
                                                        </form>
                                                    @endif
                                                </span>
                                            </td>
