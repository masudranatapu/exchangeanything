                        ...
                        <div class="col-12">
                            <div class="dashboard-card dashboard-card--benefits">
                                ...
                                @if ($userplan->is_active == 0)
                                    <p>
                                        You will be notified by email as soon as the account has been approved. (Please
                                                ...
                                                @else
                                                    <span style="margin-right: 5px;">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            ...
                                                            stroke="#d32323" stroke-width="2" stroke-linecap="round"
                                                ...
                                                <div class="cards__info-top">
                                                    <h6>
                                                        ...
                                                        <span class="float-end">
                                                            <a
                                                                href="{{ route('frontend.seller.profile', $ad->customer->username) }}">
