                                                                ...
                                                                <li class="dashboard__nav-item">
                                                                    <a href="mailto:rabin@gamil.com" class="seller-dashboard__nav-link">
                                                                        <span class="icon">
                                                                            ...
                                                                            <path d="M21 5.25L12 13.5L3 5.25" stroke="#3db83a" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                        <path d="M3 5.25H21V18C21 18.1989 20.921 18.3897 20.7803 18.5303C20.6397 18.671 20.4489 18.75 20.25 18.75H3.75C3.55109 18.75 3.36032 18.671 3.21967 18.5303C3.07902 18.3897 3 18.1989 3 18V5.25Z" stroke="#3db83a" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                    <path d="M10.3637 12L3.23132 18.5381" stroke="#3db83a" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                <path d="M20.7688 18.5381L13.6364 12" stroke="#3db83a" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                                                            </svg>
                                                        </span>
                                                        {{ $user->email }}
                                                    </a>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="http://dukalatu.webdevs4u.com/report" method="post">
                                                                    <input type="hidden" name="_token" value="pZNbnjmtC6KphwFwSkAfkG40CJ44e6PW4nZ8BaKv">                    <input type="hidden" name="user_id" value="1">
