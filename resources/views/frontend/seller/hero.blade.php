    ...
    <div class="d--flex justify-content-between">
        <div class="dd--flex align-items-center">
            <div class="d-flex">
                <div class="total-star">
                    <span class="total-star-text"></span>
                </div>
                <div class="ml--16 d-flex align-items-center">
                    <div class="mb-auto">
                    </div>
                    <div class="">
                        <div class="average-rating-text"></div>
                        <div class="average-rating-muted-text"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-between align-items-center active-ads mt-12-px">
            <div class="active-ads-amount">
                <span class="active-ads-amount-number"></span>
            ...
            <div>
                <svg width="52" height="52" viewBox="0 0 52 52" fill="none"
                    ...
                    <path d="M22 29H30" stroke="#dc3545" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M22 25H30" stroke="#dc3545" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path
