            ...
            <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td class="header"
                        ...
                        <a href="http://exchangeanything.com/"
                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0; text-align: left;">

                                    Hello <strong>{{$data['customer']['name']}}</strong>, your ads <strong>{{$data['title']}}</strong>, will be expired in <strong>{{ date('d-M-Y', strtotime($data['expire_date'])) }}</strong> 
                                    </p>
                                </td>
                            </tr>
                            <tr>
