            ...
            <div class="card-body login-card-body">
                ...
                <form method="POST" action="{{ route('admin.password.update') }}">
                    ...
                    <div class="input-group mb-3 d-none">
                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="{{ __('email') }}" value="{{ request('email','') }}">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="{{ __('confirm_password') }}">
