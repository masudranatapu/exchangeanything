            ...
            <div class="registration-form__wrapper">
                <form action="{{ route('customer.register') }}" method="POST" onsubmit="return checkForm(this);">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="input-field">
                                <input type="password" id="password-field" name="password" placeholder="{{ __('password') }}" class="@error('password') is-invalid border-danger @enderror" />
                        ...
                        <div class="col-md-6">
                            <div class="input-field">
                                <input type="password" name="password_confirmation" placeholder="{{ __('confirm password') }}" id="password-field2" class="@error('password') is-invalid border-danger @enderror" />
