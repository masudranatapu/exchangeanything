                        ...
                        <div class="search__content-item" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="padding:0;">
                            <div class="input-field input-field--transparent">
                                ...
                                <span class="icon icon--left">
                                    ...
                                    <path d="M12 12.75C13.6569 12.75 15 11.4069 15 9.75C15 8.09315 13.6569 6.75 12 6.75C10.3431 6.75 9 8.09315 9 9.75C9 11.4069 10.3431 12.75 12 12.75Z" stroke="#bb9645" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M19.5 9.75C19.5 16.5 12 21.75 12 21.75C12 21.75 4.5 16.5 4.5 9.75C4.5 7.76088 5.29018 5.85322 6.6967 4.4467C8.10322 3.04018 10.0109 2.25 12 2.25C13.9891 2.25 15.8968 3.04018 17.3033 4.4467C18.7098 5.85322 19.5 7.76088 19.5 9.75V9.75Z" stroke="#bb9645" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </span>
                            </div>
                        </div>
                    ...
                    <div class="search__content-item" data-bs-toggle="modal" data-bs-target="#staticBackdropCat" style="padding:0;">
                        <div class="input-field input-field--transparent">
                            ...
                            <span class="icon icon--left" style="left:9px !important;">
                                <svg viewBox="0 0 24 24" width="24" height="24" stroke="#bb9645" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
