<form class="form-horizontal" action="{{ route('setting', 'website') }}" method="POST" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    ...
    <div class="row ">
        <div class="col-6">
            <div class="form-group">
                ...
                <x-forms.switch-input name="ads_admin_approval" value="{{ $setting->ads_admin_approval ? 1 : 0 }}"
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input value="{{ $setting->email }}" name="email" type="email"
                    ...
                    placeholder="{{ __('enter_site_email') }}">
                @error('email')
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input value="{{ $setting->phone }}" name="phone" type="text"
                    ...
                    placeholder="{{ __('enter_site_phone') }}">
                @error('phone')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <textarea value="{{ $setting->address }}" name="address" class="form-control @error('address') is-invalid @enderror"
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <textarea value="{{ $setting->map_address }}" name="map_address"
                    class="form-control @error('map_address') is-invalid @enderror" placeholder="{{ __('enter_iframe_link') }}">{{ $setting->map_address }}</textarea>
                @error('map_address')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
